...
- Re-verified on **2026-02-12** with `DB_CONNECTION=sqlite DB_DATABASE=':memory:' php artisan test --filter='SpikeResolutionTest::can resolve breakdown spike early and deduct cost'` and the test passes.
