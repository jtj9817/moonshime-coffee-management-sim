...
#### TICKET-001: Incorrect COGS Calculation (Weighted vs Simple Average)
...
#### TICKET-002: N+1 Query in COGS Calculation
...
#### TICKET-003: N+1 Query in Demand Simulation (Spikes)
- **Severity**: High (Performance)
...
#### TICKET-004: Reliance on `active()` Scope in Simulation
...
#### TICKET-005: Duplicated Storage Fee Logic
