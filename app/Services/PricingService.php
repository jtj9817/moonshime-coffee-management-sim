...
class PricingService
{
     ...
     */
    public function calculateUnitCost(Product $product, User $user, ?int $vendorId = null): int
    {
        ...
        $priceMultiplier = $this->getPriceMultiplier($user->id, $product->id, $vendorId);
     ...
     */
    protected function getPriceMultiplier(int $userId, string $productId, ?int $vendorId = null): float
    {
