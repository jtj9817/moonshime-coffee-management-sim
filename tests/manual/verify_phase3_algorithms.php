...
try {
    ...
    if (! $reachable) {
        throw new Exception('BFS failed to find Warehouse A!');
    }
    ...
    if ($reachable) {
        throw new Exception('BFS found path when none exists!');
    }
    ...
    if ($totalCost !== 20) {
        throw new Exception("Dijkstra failed! Expected Cost 20, got {$totalCost}");
    }
    ...
    if ($totalCost !== 50) {
        throw new Exception("Dijkstra failed rerouting! Expected Cost 50, got {$totalCost}");
    }
