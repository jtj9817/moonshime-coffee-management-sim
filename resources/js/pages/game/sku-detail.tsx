...
function getStockStatus(quantity: number) {
    ...
    if (quantity < 50) return { label: 'Low Stock', color: 'secondary' as const };
    if (quantity < 100) return { label: 'Medium Stock', color: 'default' as const };
                    ...
                    <CardContent>
                        <div className="flex items-center gap-6">
                            ...
                            <div className="flex-1">
                                ...
                                <Progress value={stockPercent} className="h-3" />
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="flex items-center justify-between border-b border-stone-100 pb-3 dark:border-stone-800">
                                <span className="text-stone-500">Perishable</span>
                                <span className="font-medium">
                                    {product.is_perishable ? 'Yes' : 'No'}
                                </span>
                            </div>
                            <div className="flex items-center justify-between border-b border-stone-100 pb-3 dark:border-stone-800">
                                <span className="text-stone-500">Storage Cost</span>
                                <span className="font-medium">
                                    ${product.storage_cost.toFixed(2)}/unit/day
                                </span>
                            </div>
                            <div className="flex items-center justify-between">
                                <span className="text-stone-500">Last Restocked</span>
                                <span className="font-medium">
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="flex items-center justify-between">
                                <span className="text-stone-500">Max Storage</span>
                                <span className="font-medium">
                                    {location.max_storage.toLocaleString()} units
                                </span>
                            </div>
                        </CardContent>
                    </Card>
                            ...
                            {quantity === 0 && (
                                <div className="rounded-lg border border-rose-200 bg-rose-50 p-4 dark:border-rose-800 dark:bg-rose-950">
                                    ...
                                    <p className="text-sm text-rose-600 dark:text-rose-400">
                                        This item is out of stock. Place an emergency order to avoid
                                        service disruptions.
                                    </p>
                                </div>
                            )}
                            {quantity > 0 && quantity < 50 && (
                                <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-800 dark:bg-amber-950">
                                    ...
                                    <p className="text-sm text-amber-600 dark:text-amber-400">
                                        Stock is running low. Consider placing an order within the
                                        next 1-2 days.
                                    </p>
                                </div>
                            )}
                            {quantity >= 50 && (
                                <div className="rounded-lg border border-emerald-200 bg-emerald-50 p-4 dark:border-emerald-800 dark:bg-emerald-950">
                                    ...
                                    <p className="text-sm text-emerald-600 dark:text-emerald-400">
                                        Current stock levels are adequate. Monitor for any demand
                                        spikes.
                                    </p>
                                </div>
                            )}
